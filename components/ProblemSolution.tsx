  ...
  return (
    <section className="bg-white py-12 md:py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <Reveal>
          <SectionHeading 
            title="Modern Life is Loud. We Offer Silence." 
            subtitle="Bridging the gap between Himalayan tradition and urban performance."
          />
        </Reveal>
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-20 items-start mt-10">
          ...
          <div className="space-y-4">
            <Reveal delay={0.1}>
              <h3 className="text-xl md:text-2xl uppercase tracking-[0.1em] font-bold text-slate-500 mb-4 border-b border-slate-100 pb-2">The Modern Struggle</h3>
            </Reveal>
          ...
          <div className="space-y-4">
            <Reveal delay={0.1}>
              <h3 className="text-xl md:text-2xl uppercase tracking-[0.1em] font-bold text-teal-600 mb-4 border-b border-teal-100 pb-2">The Rishikesh Solution</h3>
            </Reveal>
